echo "-----+++-"
##echo $entitle
#PARAM_DEVELOPTEAM=$(/usr/libexec/PlistBuddy -c 'Print :CFBundleDisplayName' "/var/folders/0b/x414pv1x3dnfnkgd1zxmdq600000gn/T/com.epoint.fastsign/fsTemp/temp/Payload/EpointiOSFrameV7.app/Info.plist")
...
#  echo "-----+++-"
#  echo $entitle
#  /usr/libexec/PlistBuddy -c 'Print :CFBundleDisplayName' "/Users/zhudezhen/Desktop/重签名测试/测试项目/Payload/EpointiOSFrameV7.app/Info.plist"
#  echo $PARAM_DEVELOPTEAM
#  echo "-----+++-"
#  # 提取 Entitlements 字段
